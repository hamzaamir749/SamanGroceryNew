...
public class HomeVerticalAdapter extends RecyclerView.Adapter<HomeVerticalAdapter.modelViewHolder> {
    ...
    MultiTypesProductsActivity multiTypesProductsActivity;

    public HomeVerticalAdapter(List<ProductsModel> list, Context context) {
        this.list = list;
        ...
        multiTypesProductsActivity=new MultiTypesProductsActivity();
    }

    @NonNull
    @Override
    public modelViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context.getApplicationContext()).inflate(R.layout.item_search_categories, parent, false);
        ...
        holder.addCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (product.isVeriations()) {
                    ...
                    if (className.equals("SubCategoriesActivity")){
                        subCategoriesActivity.ShowBadge(UserSessionManager.cart.getTotalItems());
                    }
                    if (className.equals("MultiTypesProductsActivity")){
                        multiTypesProductsActivity.ShowBadge(UserSessionManager.cart.getTotalItems());
                    }
                    holder.total.setText(String.valueOf(UserSessionManager.cart.getItemQuantity(product.getmID())));
                    holder.plusminusRelative.setVisibility(View.VISIBLE);
                    holder.addCart.setVisibility(View.GONE);
